...
$(document).ready(function(){
    ...
    //二维码标题
    var _codetitle_public = '57美国网';
    var _codetitle_study = '57美国留学';
    var _codetitle_tour = '57美国旅游';
    //二维码图处url
    var _codeimgurl_public = 'http://images.lzq.com/img/common/wx.png'; //公用二维码
    var _codeimgurl_study = 'http://images.lzq.com//img/common/wxstudy.jpg';	//留学二维码
    var _codeimgurl_tour = 'http://images.lzq.com//img/common/wxtravel.jpg';	//旅游二维码
    //根据url判断使用对应二维码
    if(DnPrefix == 'www' || DnPrefix == 'lzq'){
        /*code_content($thisDom,_codetitle_public,_codeimgurl_public);*/
        $thisDom.html("");
        $thisDom.parent(".FixSecond ").css({
            "width":"424px"
        });
        $thisDom.css({
            "padding":"0 0 0 10px"
        ...
        var codehtml="";
        codehtml +='<div class="www_codeNew"><img src="'+_codeimgurl_public+'" width="134px"><p>'+_codetitle_public+'</p></div>';
        codehtml +='<div class="www_codeNew"><img src="'+_codeimgurl_tour+'" width="134px"><p>'+_codetitle_tour+'</p></div>';
        codehtml +='<div class="www_codeNew"><img src="'+_codeimgurl_study+'" width="134px"><p>'+_codetitle_study+'</p></div>';
        $thisDom.append(codehtml);
    ...
    //分享图片
    var share_pic = "http://images.lzq.com/img/common/logo.png";
...
function code_content($thisDom,title,url) {
    $thisDom.html("");
    $thisDom.append('<img src="'+ url +'" width="134"/><p>'+title+'</p>');
}
